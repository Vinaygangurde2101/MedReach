...
HttpSession session2 = request.getSession(false); 
  ...
  if (session != null && session.getAttribute("did") != null) {
      doctorId = (Integer) session.getAttribute("did");
  } else {
  ...
  try {
    ...
    PreparedStatement ps = con.prepareStatement(
      "SELECT a.aid, a.pid, a.adate, a.atime, a.astatus, " +
      "p.pname, p.pcontact, p.pemail " +
      "FROM appointments a " +
...
%>
  <tr>
    ...
    <td>
      <a href="acceptAppo.jsp?aid=<%= rs.getInt("aid") %>">Accept</a>
    </td>
  </tr>
<%
    }
