...
<table>
  ...
  try {
    ...
    PreparedStatement ps = con.prepareStatement("select * from doctordetails");
  ...
  <tr>
    ...
    <td>
      <a href="deleteAccount.jsp?did=<%= rs.getInt(1) %>">Delete</a>
    </td> 
    <td>
    <a class="book-btn" href="bookAppointment.jsp?did=<%= rs.getInt(1) %>">Book Appointment</a>
</td>
  </tr>
  <%
    }
